...
class Character:
    def __init__(self, x, y, grid, astar: AStar, color=(255, 0, 0)):
        ...
        self.color = color  # Asignar el color
    ...
    def draw(self, screen):
        # Dibujar el personaje como un círculo rojo en el centro de la tile
